...
public class ProjectController {
    ...
    @Autowired
    public ProjectController(ProjectService projectService, ProjectLikeService projectLikeService, UserService userService, ApplyService applyService, ResponseService responseService) {
