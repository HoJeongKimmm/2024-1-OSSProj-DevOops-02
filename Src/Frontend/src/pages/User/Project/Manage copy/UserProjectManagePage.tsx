...
export const CompetitionUserProjectManagePage: FC<CompetitionUserProjectManagePageProps> = ({ className }) => {
  ...
  const items: TabsProps['items'] = [
    ...
    },
    {
      key: '2',
      label: `멤버 지원승인`,
      children: <CompetitionApproveMemberSection />,
    },
    {
      key: '3',
      label: `게시글 수정`,
