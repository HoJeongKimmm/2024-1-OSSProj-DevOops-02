...
export const CommonHeader: FC<CommonHeaderProps> = ({ className }) => {
  ...
  const onClickProjectListDonggukButton = () => {
    navigate('/project/listDongguk')
  }
  ...
  const onClickCreateResumeButton = () => {
    navigate('/resume/createResume')
  }
      ...
      <Container>
        <MenuContainer>
          ...
          <MenuButtonContainer>
            ...
            <MenuProjectButton type={'text'} onClick={onClickProjectListDonggukButton}>
              <MenuProjectButtonTypo>강의별 팀구성 보기</MenuProjectButtonTypo>
            </MenuProjectButton>
            <MenuProjectButton type={'text'} onClick={onClickProjectCreateButton}>
              <MenuProjectButtonTypo>프로젝트 생성하기</MenuProjectButtonTypo>
            </MenuProjectButton>
            <MenuProjectButton type={'text'} onClick={onClickCreateResumeButton}>
              <MenuProjectButtonTypo>이력서 관리하기</MenuProjectButtonTypo>
            </MenuProjectButton>
          </MenuButtonContainer>
        </MenuContainer>
        {renderUserContainer()}
